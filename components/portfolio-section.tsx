...
const projects = [
  {
    title: "M4Markets - Broker KPIs",
    description: "Sistema de dashboards y KPIs para broker de trading. Métricas de rendimiento, tracking de IBs, pipelines de leads con IA.",
    image: "/projects/m4markets.png",
    tags: ["Python", "FastAPI", "Next.js", "LangChain", "Railway"],
    icon: BarChart3,
    colorClass: "bg-service-primary",
    link: "#",
    type: "Desarrollo Interno",
  },
  {
    title: "FlyAgency v2",
    description: "Agencia de leads con IA. Sistema de captura, calificación automática con S.C.O.R.E., WhatsApp automation y CRM integration.",
    image: "/projects/flyagency.png",
    tags: ["Next.js", "FastAPI", "Claude API", "Langfuse", "N8N"],
    icon: Bot,
    colorClass: "bg-service-primary",
    link: "#",
    type: "Producto SaaS",
  ...
  {
    title: "GC Capital Landing",
    description: "Landing page de alta conversión para copy trading. Calculadora de ROI interactiva, formulario S.C.O.R.E., sistema de cualificación.",
  ...
  },
  {
    ...
    description: "Plataforma gamificada para comunidades de trading. Sistema de XP, rankings, tracking de trades, achievements y social features.",
    image: "/projects/innova-community.png",
    tags: ["Next.js", "PostgreSQL", "Real-time", "Gamification"],
    icon: Users,
